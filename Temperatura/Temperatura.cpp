...
// Temperatura.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CTemperaturaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CTemperaturaApp

CTemperaturaApp::CTemperaturaApp()
{
...
// Único objeto CTemperaturaApp

CTemperaturaApp theApp;


// Inicialización de CTemperaturaApp

BOOL CTemperaturaApp::InitInstance()
{
